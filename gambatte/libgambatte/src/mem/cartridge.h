...
public:
	...
	inline bool isInterrupt(uint32_t romAddress) { return memptrs_.isInterrupt(romAddress); }
	inline void setInterrupt(uint32_t romAddress) { memptrs_.setInterrupt(romAddress); }
	inline void clearInterrupt(uint32_t romAddress) { memptrs_.clearInterrupt(romAddress); }
